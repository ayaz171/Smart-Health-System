...
<h1 class="text-monocase text-capitalize text-center text-light">All The Doctor's Of  Orthopedic</h1>
...
<li class="previous" ><a href="index.php">Previous</a></li>
  <li class="next "><a href="cardiac_electrophysiologist.php">Next Page</a></li>
</ul></div>
<?php
	   include 'footer.html';?>
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
