...
$select_address_query="select address from user where email='$email' ";
	$run_address_query=mysqli_query($db,$select_address_query);
	...
	$edit_run_address_query=mysqli_query($db,$edit_address_query);
  ...
  <div class="w3-card-4 w3-margin w3-black">
    <div class="w3-container">
                     <h1  class=" text-center font-weight-bold text-warning">Personal Profile</h1>
                        <hr color="#333333" />
<h3>
 <form action = "u_address.php" method="POST">
   

   change address:    <input type="text" name="address"><inputstyle="color:#000000" type ="submit" name="submit4" value="save"><br /> 
