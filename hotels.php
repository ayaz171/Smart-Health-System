            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <a class="btn btn-primary" href="addhotel.php">
                            Add Hotel
                        </a>
                    </h6>
                </div>
                ...
                ?>
                    ...
                    <div class="table-responsive">
                        <?php
                    $query = "SELECT * FROM hotels JOIN destinations ON destinations.destinations_id = hotels.destinations_id";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="code.php" method="post">
                                            <input type="hidden" name="hotels_delete_id"
                                                value="<?php echo $row['hotels_id']; ?>">
                                            <button type="submit" name="hotels_delete_btn" class="btn btn-danger">
                                                DELETE</button>
                                        </form>
                                    </td>
                                </tr>
