...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Smart Health Consulting System</strong></a>
    </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/111.jpg" alt="img1" width="1200" height="700">

      </div>

      <div class="item">
        <img src="pic/999.jpg" alt="img2" width="1200" height="700">
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">Smart Health Consulting System</h3>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        ...
        <i class="fa fa-phone" style="width:30px"></i> Phone: +880......<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  ayaz@gmail.com<br>
      </div>
      <?php
...
<footer class="text-center">
  ...
  <p>Smart Health Consulting System by Ayaz,Mursalin,Sraboni,Sumaia</p> 
</footer>
<script>
